...
export default function Admin() {
    ...
    return (<div className="min-h-[calc(100vh-8rem)] flex flex-col items-center justify-center">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-xl text-3xl overflow-hidden" style={{ backgroundColor: settings.accentColor }}>
        ...
        {role === "admin" ? (<Card data-testid="admin-panel">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="destructive" className="w-full" onClick={handleLogout} data-testid="button-admin-logout">
          ...
          </Card>) : (<Card data-testid="admin-login-form">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
            ...
            <CardContent>
              <Tabs defaultValue="admin">
                  ...
                  {!ownerConfigured ? (<div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <Input id="admin-password" type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" data-testid="input-admin-password" className="pr-10"/>
                          <button type="button" onClick={() => setShowPassword((v) => !v)} className="absolute inset-y-0 right-0 flex items-center pr-3 text-muted-foreground hover:text-foreground" aria-label={showPassword ? "Hide password" : "Show password"} data-testid="toggle-admin-password">
                ...
                <TabsContent value="student" className="space-y-4">
                  ...
                  <Button onClick={handleStudentLogin} className="w-full" data-testid="button-student-login">
